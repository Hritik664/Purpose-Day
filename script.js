        ...
        if (window.innerWidth < 600) {
            drawTextWithLineBreaks(
                [
                    ...
                    "the world to share that friendship bond with you!",
                ],
                canvas.width / 2,
                canvas.height / 2 + 70,
                fontSize,
            ...
            context.fillText(
                "and I can't wait to spend all the time in the world to share that friendship bond with you!",
                canvas.width / 2,
                canvas.height / 2 + 50
            );
        }
